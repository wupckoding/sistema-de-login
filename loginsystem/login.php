...
<form class="form" method="post">
    <div class="form-inner">
        <h2>Wupc telas</h2>
        <div class="input-wrapper"><label for="login-username">Nome de usuário</label>
            <div class="input-group"><span class="icon"><svg viewBox="0 0 24 24">
                        <path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path>
                    </svg></span><input type="text" name="login" data-lpignore="true" /></div>
        </div>
        <div class="input-wrapper"><label for="login-password">Senha</label>
            <div class="input-group"><span class="icon"><svg viewBox="0 0 24 24">
                    ...
                    </svg></span><input type="password" name="senha" data-lpignore="true" /></div>
        </div>
        <div class="btn-group"><input type="submit" name="acao" value="Login" ><a class="btn--text" href="#0">Não esquece a senha arrombado</a></div>
    </div>
</form>
</body>
</html>